    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="<?php echo e(url('/')); ?>" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i><?php echo e(config('app.name', 'Jualin')); ?></h3>
                </a>
                ...
                <div class="bg-secondary rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="#">2024 jualin.com</a>, All Right Reserved. 
                        </div>
...
</html><?php /**PATH C:\laragon\www\jualin\resources\views/layouts/admin.blade.php ENDPATH**/ ?>